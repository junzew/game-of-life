...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['Font'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(name, size) {
			...
			var $iter5_nextval,$iter6_type,$iter5_array,$iter8_iter,$iter5_iter,$iter5_type,$iter6_iter,font,$iter6_nextval,$iter5_idx,$iter8_idx,$iter6_idx,$iter7_iter,$iter8_type,$iter6_array,$iter8_nextval,ff,$iter7_idx,load_custom_font,fn,c,$iter7_type,$iter7_nextval,f,i,$iter7_array,$iter8_array,$add2,$add3,$add1,$add4,fallback;
			if ($p['bool'](!$p['bool'](name))) {
				font = $p['list']([$p['getattr']($m['Font'], '_font')['__getitem__'](0)]);
			}
			else {
				font = function(){
	...
	return $collcomp2;}();
			...
			while (typeof($p['__wrapped_next']($iter5_nextval)['$nextval']) != 'undefined') {
				...
				i = $tupleassign2[0];
				fn = $tupleassign2[1];
				if ($p['bool'](fn['__contains__']('.'))) {
					fn = fn['$$split']('.')['__getitem__'](0);
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('render', function(text, antialias, color, background, surface) {
			...
			surf['fillText'](text, (typeof ($div1=w)==typeof ($div2=2) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2)), (typeof ($div3=h)==typeof ($div4=2) && typeof $div3=='number' && $div4 !== 0?
				$div3/$div4:
				$p['op_div']($div3,$div4)));
			if ($p['bool']($p['getattr'](self, 'underline'))) {
				surf['setLineWidth']((typeof ($div5=$p['getattr'](self, 'fontsize'))==typeof ($div6=20) && typeof $div5=='number' && $div6 !== 0?
					$div5/$div6:
					$p['op_div']($div5,$div6)));
				surf['setStrokeStyle']($m['Color'](color));
				surf['beginPath']();
				surf['moveTo'](0, (typeof ($mul1=h)==typeof ($mul2=0.85) && typeof $mul1=='number'?
					$mul1*$mul2:
					$p['op_mul']($mul1,$mul2)));
				surf['lineTo'](w, (typeof ($mul3=h)==typeof ($mul4=0.85) && typeof $mul3=='number'?
					$mul3*$mul4:
					$p['op_mul']($mul3,$mul4)));
				surf['stroke']();
			}
	...
	, 1, [null,null,['self'],['text'],['antialias', true],['color', $p['tuple']([0, 0, 0])],['background', null],['surface', null]]);
		...
		$method = $pyjs__bind_method2('size', function(text) {
			...
			y = $p['float_int']((typeof ($mul5=$p['getattr'](self, 'fontsize'))==typeof ($mul6=1.2) && typeof $mul5=='number'?
				$mul5*$mul6:
				$p['op_mul']($mul5,$mul6)));
			return $p['tuple']([x, y]);
		}
	, 1, [null,null,['self'],['text']]);
		...
		$method = $pyjs__bind_method2('_size_estimate', function(text) {
			...
			var $iter9_iter,$mul10,$iter9_nextval,$iter9_idx,$iter9_array,$$char,$pyjs_try_err,$mul9,$mul8,$mul7,x,$iter9_type,size;
			...
			while (typeof($p['__wrapped_next']($iter9_nextval)['$nextval']) != 'undefined') {
				...
				try {
					size['append']((typeof ($mul7=$p['getattr'](self, 'char_size')['__getitem__']($$char))==typeof ($mul8=$p['getattr'](self, 'fontsize')) && typeof $mul7=='number'?
						$mul7*$mul8:
						$p['op_mul']($mul7,$mul8)));
				} catch($pyjs_try_err) {
					var $pyjs_try_err_name = (typeof $pyjs_try_err['__name__'] == 'undefined' ? $pyjs_try_err['name'] : $pyjs_try_err['__name__'] );
					...
					if (($pyjs_try_err_name == $p['KeyError']['__name__'])||$p['_isinstance']($pyjs_try_err,$p['KeyError'])) {
						size['append']((typeof ($mul9=$p['getattr'](self, 'char_size')['__getitem__']('x'))==typeof ($mul10=$p['getattr'](self, 'fontsize')) && typeof $mul9=='number'?
							$mul9*$mul10:
							$p['op_mul']($mul9,$mul10)));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('set_bold', function(setting) {
			...
			self['fontstyle'] = $p['__op_add']($add7=$p['__op_add']($add5=$p['getattr'](self, 'bold'),$add6=' '),$add8=$p['getattr'](self, 'italic'));
			return null;
		}
	, 1, [null,null,['self'],['setting', true]]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('set_italic', function(setting) {
			...
			self['fontstyle'] = $p['__op_add']($add11=$p['__op_add']($add9=$p['getattr'](self, 'bold'),$add10=' '),$add12=$p['getattr'](self, 'italic'));
			return null;
		}
	, 1, [null,null,['self'],['setting', true]]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('get_linesize', function() {
			...
			var $mul12,$mul11;
			return $p['float_int']((typeof ($mul11=$p['getattr'](self, 'fontsize'))==typeof ($mul12=1.2) && typeof $mul11=='number'?
				$mul11*$mul12:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_get_char_size', function(font) {
			...
			var char_size,$iter10_nextval,$iter10_array,$div7,$$char,$div8,fontsize,$iter10_type,$iter10_iter,$iter10_idx;
			if ($p['bool'](!$p['bool'](font))) {
				...
				while (typeof($p['__wrapped_next']($iter10_nextval)['$nextval']) != 'undefined') {
					...
					char_size['__setitem__']($$char, $p['float']((typeof ($div7=$m['_surf']['measureText']($$char))==typeof ($div8=fontsize) && typeof $div7=='number' && $div8 !== 0?
						$div7/$div8:
						$p['op_div']($div7,$div8))));
				}
				return char_size;
	...
	$m['SysFont'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(name, size, bold, italic) {
			...
			self['fontstyle'] = $p['__op_add']($add15=$p['__op_add']($add13=$p['getattr'](self, 'bold'),$add14=' '),$add16=$p['getattr'](self, 'italic'));
			return null;
		}
