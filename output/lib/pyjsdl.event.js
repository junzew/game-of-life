...
$pyjs['loaded_modules']['pyjsdl.event'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('get', function(eventType) {
			...
			var evtType,$iter12_type,i,$iter11_type,$iter12_array,$iter11_array,$iter12_iter,$iter11_iter,$iter11_nextval,$iter11_idx,$iter12_idx,$iter12_nextval;
			if ($p['bool'](!$p['bool']($p['getattr'](self, 'eventNum')))) {
				return $p['getattr'](self, 'queueNil');
			}
			self['_lock']();
	...
	return $collcomp7;}();
				...
				while (typeof($p['__wrapped_next']($iter11_nextval)['$nextval']) != 'undefined') {
					...
					if ($p['bool'](!evtType['__contains__']($p['getattr']($p['getattr'](self, 'eventQueue')['__getitem__'](i), 'type')))) {
						self['queueTmp']['append']($p['getattr'](self, 'eventQueue')['__getitem__'](i));
					}
					else {
						self['queue']['append']((typeof JEvent == "undefined"?$m['JEvent']:JEvent)($p['getattr'](self, 'eventQueue')['__getitem__'](i)));
					}
				}
				if ($p['bool'](!$p['bool']($p['getattr'](self, 'queueTmp')))) {
					self['eventNum'] = 0;
				}
				else {
					self['eventNum'] = $p['len']($p['getattr'](self, 'queueTmp'));
					$iter12_iter = $p['range']($p['getattr'](self, 'eventNum'));
					$iter12_nextval=$p['__iter_prepare']($iter12_iter,false);
					while (typeof($p['__wrapped_next']($iter12_nextval)['$nextval']) != 'undefined') {
						i = $iter12_nextval['$nextval'];
						$p['getattr'](self, 'eventQueue')['__setitem__'](i, $p['getattr'](self, 'queueTmp')['__getitem__'](i));
					}
					$p['__setslice']($p['getattr'](self, 'queueTmp'), 0, null, $p['list']([]));
				}
				if ($p['bool'](($p['cmp']($p['getattr'](self, 'eventNum'), 250) == 1))) {
					self['_pump']();
				}
	...
	, 1, [null,null,['self'],['eventType', null]]);
		...
		$method = $pyjs__bind_method2('clear', function(eventType) {
			...
			if (typeof eventType == 'undefined') eventType=arguments['callee']['__args__'][3][1];
			var evtType,$iter21_idx,$iter22_array,i,$iter21_nextval,$iter22_nextval,$iter22_idx,$iter21_type,$iter21_iter,$iter22_type,$iter21_array,$iter22_iter;
			if ($p['bool'](!$p['bool']($p['getattr'](self, 'eventNum')))) {
				return null;
			}
			self['_lock']();
