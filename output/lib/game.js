...
$pyjs['loaded_modules']['game'] = function (__mod_name__) {
	...
	$m['run'] = function() {
		var $iter6_idx,$iter6_type,mainloop,$add34,$iter6_array,$add33,playtime,$iter6_iter,$iter6_nextval,$div6,event,milliseconds,$div5;
		mainloop = true;
		playtime = 0.0;
		while ($p['bool'](mainloop)) {
			milliseconds = $m['clock']['tick']($m['FPS']);
			playtime = $p['__op_add']($add33=playtime,$add34=(typeof ($div5=milliseconds)==typeof ($div6=1000.0) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
