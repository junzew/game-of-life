...
$pyjs['loaded_modules']['pyjsdl.mask'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('overlap', function(mask, offset) {
			...
			var $iter13_idx,y1,y2,$add49,$add48,$add47,$add46,$add44,$add43,$sub9,$iter13_type,$and9,$sub13,$sub12,$sub11,$sub10,$sub16,$sub15,$sub14,$and10,x2,x1,$add50,$iter13_nextval,$iter13_iter,h,$iter13_array,w,y,$add45;
			if ($p['bool'](($p['cmp'](offset['__getitem__'](0), 0) == 1))) {
				x1 = offset['__getitem__'](0);
				x2 = 0;
			}
			else {
				x1 = 0;
				x2 = (typeof ($usub1=offset['__getitem__'](0))=='number'?
					-$usub1:
					$p['op_usub']($usub1));
			}
			if ($p['bool'](($p['cmp'](offset['__getitem__'](1), 0) == 1))) {
				y1 = offset['__getitem__'](1);
				y2 = 0;
			}
			else {
				y1 = 0;
				y2 = (typeof ($usub2=offset['__getitem__'](1))=='number'?
					-$usub2:
					$p['op_usub']($usub2));
			}
			...
			if ($p['bool'](($p['bool']($and9=($p['cmp'](w, 0) == 1))?($p['cmp'](h, 0) == 1):$and9))) {
	...
	, 1, [null,null,['self'],['mask'],['offset']]);
		...
		$method = $pyjs__bind_method2('toString', function(bit) {
			...
			var bitstr,$iter14_array,$iter14_type,cbit,cbitset,bitset,$iter14_iter,$iter14_idx,$iter14_nextval;
			...
			while (typeof($p['__wrapped_next']($iter14_nextval)['$nextval']) != 'undefined') {
				...
				cbitset['extend'](function(){
					var $iter15_iter,i,$iter15_array,$collcomp1,$iter15_idx,$iter15_nextval,$iter15_type;
	$collcomp1 = $p['list']();
				...
				while (typeof($p['__wrapped_next']($iter15_nextval)['$nextval']) != 'undefined') {
					...
					$collcomp1['append'](cbit['__getitem__'](bitset['get'](i)));
				}
