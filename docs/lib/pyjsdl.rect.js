...
$pyjs['loaded_modules']['pyjsdl.rect'] = function (__mod_name__) {
	...
	$m['Rect'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			if ($p['bool']($p['op_eq'](ln, 4))) {
				self['setLocation'](arg['__getitem__'](0), arg['__getitem__'](1));
				self['setSize'](arg['__getitem__'](2), arg['__getitem__'](3));
			}
			else if ($p['bool']($p['op_eq'](ln, 2))) {
				self['setLocation'](arg['__getitem__'](0)['__getitem__'](0), arg['__getitem__'](0)['__getitem__'](1));
				self['setSize'](arg['__getitem__'](1)['__getitem__'](0), arg['__getitem__'](1)['__getitem__'](1));
			}
			else {
	...
	, 1, [null,null,['self'],['rect_list']]);
		...
		$method = $pyjs__bind_method2('clamp', function(rect) {
			...
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'width'), $p['getattr'](rect, 'width')) == -1))) {
				...
				x = $p['__op_sub']($sub65=$p['getattr'](rect, 'x'),$sub66=$p['float_int']((typeof ($div41=$p['__op_sub']($sub63=$p['getattr'](self, 'width'),$sub64=$p['getattr'](rect, 'width')))==typeof ($div42=2) && typeof $div41=='number' && $div42 !== 0?
					$div41/$div42:
			...
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'height'), $p['getattr'](rect, 'height')) == -1))) {
				...
				y = $p['__op_sub']($sub71=$p['getattr'](rect, 'y'),$sub72=$p['float_int']((typeof ($div43=$p['__op_sub']($sub69=$p['getattr'](self, 'height'),$sub70=$p['getattr'](rect, 'height')))==typeof ($div44=2) && typeof $div43=='number' && $div44 !== 0?
					$div43/$div44:
	...
	, 1, [null,null,['self'],['rect']]);
		...
		$method = $pyjs__bind_method2('clamp_ip', function(rect) {
			...
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'width'), $p['getattr'](rect, 'width')) == -1))) {
				...
				x = $p['__op_sub']($sub77=$p['getattr'](rect, 'x'),$sub78=$p['float_int']((typeof ($div45=$p['__op_sub']($sub75=$p['getattr'](self, 'width'),$sub76=$p['getattr'](rect, 'width')))==typeof ($div46=2) && typeof $div45=='number' && $div46 !== 0?
					$div45/$div46:
			...
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'height'), $p['getattr'](rect, 'height')) == -1))) {
				...
				y = $p['__op_sub']($sub83=$p['getattr'](rect, 'y'),$sub84=$p['float_int']((typeof ($div47=$p['__op_sub']($sub81=$p['getattr'](self, 'height'),$sub82=$p['getattr'](rect, 'height')))==typeof ($div48=2) && typeof $div47=='number' && $div48 !== 0?
					$div47/$div48:
	...
	if ($p['bool']($p['getattr']($p['getattr']($m['env'], 'pyjs_mode'), 'strict'))) {
		$m['Rect']['setLocation'] = $p['getattr']($m['Rect'], '_setLocation');
		$m['Rect']['setSize'] = $p['getattr']($m['Rect'], '_setSize');
	}
	$m['RectPool'] = (function(){
		var $cls_definition = new Object();
		var $method;
