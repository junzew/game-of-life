...
$pyjs['loaded_modules']['pyjsdl.draw'] = function (__mod_name__) {
	...
	$m['Draw'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			var $div2,$div1;
			self['rad_deg'] = (typeof ($div1=180.0)==typeof ($div2=$m['_pi']) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('rect', function(surface, color, rect, width) {
			...
			if ($p['bool'](width)) {
				...
				if ($p['bool'](!$p['op_eq']($p['getattr'](surface, '_stroke_style'), color))) {
				...
				if ($p['bool'](!$p['op_eq']($p['getattr'](surface, '_fill_style'), color))) {
			...
			if ($p['bool'](!$p['bool']($p['getattr'](self, '_return_rect')))) {
				return null;
			}
	...
	, 1, [null,null,['self'],['surface'],['color'],['rect'],['width', 0]]);
		...
		$method = $pyjs__bind_method2('circle', function(surface, color, position, radius, width) {
			...
			surface['beginPath']();
			surface['arc'](position['__getitem__'](0), position['__getitem__'](1), radius, 0, (typeof ($mul1=2)==typeof ($mul2=$m['_pi']) && typeof $mul1=='number'?
				$mul1*$mul2:
	...
	, 1, [null,null,['self'],['surface'],['color'],['position'],['radius'],['width', 0]]);
		...
		$method = $pyjs__bind_method2('ellipse', function(surface, color, rect, width) {
			...
			if ($p['bool'](((($p['cmp']($p['getattr'](_rect, 'width'), $p['getattr'](_rect, 'height')))|1) == 1))) {
				...
				radius = $p['float_int']((typeof ($div9=$p['getattr'](_rect, 'height'))==typeof ($div10=2) && typeof $div9=='number' && $div10 !== 0?
					$div9/$div10:
					$p['op_div']($div9,$div10)));
			}
			else {
				surface['scale'](1, (typeof ($div11=$p['getattr'](_rect, 'height'))==typeof ($div12=(typeof ($mul13=$p['getattr'](_rect, 'width'))==typeof ($mul14=1.0) && typeof $mul13=='number'?
					$mul13*$mul14:
					$p['op_mul']($mul13,$mul14))) && typeof $div11=='number' && $div12 !== 0?
					$div11/$div12:
					$p['op_div']($div11,$div12)));
				radius = $p['float_int']((typeof ($div13=$p['getattr'](_rect, 'width'))==typeof ($div14=2) && typeof $div13=='number' && $div14 !== 0?
					$div13/$div14:
					$p['op_div']($div13,$div14)));
			}
			surface['beginPath']();
			surface['arc'](0, 0, radius, 0, (typeof ($mul15=2)==typeof ($mul16=$m['_pi']) && typeof $mul15=='number'?
				$mul15*$mul16:
	...
	, 1, [null,null,['self'],['surface'],['color'],['rect'],['width', 0]]);
		...
		$method = $pyjs__bind_method2('arc', function(surface, color, rect, start_angle, stop_angle, width) {
			...
			if ($p['bool']($p['op_eq']($p['getattr'](_rect, 'width'), $p['getattr'](_rect, 'height')))) {
				...
				surface['saveContext']();
				surface['translate']($p['__op_add']($add9=$p['getattr'](_rect, 'x'),$add10=$p['float_int']((typeof ($div21=$p['getattr'](_rect, 'width'))==typeof ($div22=2) && typeof $div21=='number' && $div22 !== 0?
					$div21/$div22:
					$p['op_div']($div21,$div22)))), $p['__op_add']($add11=$p['getattr'](_rect, 'y'),$add12=$p['float_int']((typeof ($div23=$p['getattr'](_rect, 'height'))==typeof ($div24=2) && typeof $div23=='number' && $div24 !== 0?
					$div23/$div24:
				...
				if ($p['bool'](((($p['cmp']($p['getattr'](_rect, 'width'), $p['getattr'](_rect, 'height')))|1) == 1))) {
					surface['scale']((typeof ($div25=$p['getattr'](_rect, 'width'))==typeof ($div26=(typeof ($mul17=$p['getattr'](_rect, 'height'))==typeof ($mul18=1.0) && typeof $mul17=='number'?
						...
						$div25/$div26:
						$p['op_div']($div25,$div26)), 1);
					radius = $p['float_int']((typeof ($div27=$p['getattr'](_rect, 'height'))==typeof ($div28=2) && typeof $div27=='number' && $div28 !== 0?
						$div27/$div28:
						$p['op_div']($div27,$div28)));
				}
				else {
					surface['scale'](1, (typeof ($div29=$p['getattr'](_rect, 'height'))==typeof ($div30=(typeof ($mul19=$p['getattr'](_rect, 'width'))==typeof ($mul20=1.0) && typeof $mul19=='number'?
						$mul19*$mul20:
						$p['op_mul']($mul19,$mul20))) && typeof $div29=='number' && $div30 !== 0?
						$div29/$div30:
						$p['op_div']($div29,$div30)));
					radius = $p['float_int']((typeof ($div31=$p['getattr'](_rect, 'width'))==typeof ($div32=2) && typeof $div31=='number' && $div32 !== 0?
						$div31/$div32:
						$p['op_div']($div31,$div32)));
				}
				surface['beginPath']();
				surface['arc'](0, 0, radius, (typeof ($usub3=start_angle)=='number'?
					-$usub3:
	...
	, 1, [null,null,['self'],['surface'],['color'],['rect'],['start_angle'],['stop_angle'],['width', 1]]);
		...
		$method = $pyjs__bind_method2('polygon', function(surface, color, pointlist, width) {
			...
			if (typeof width == 'undefined') width=arguments['callee']['__args__'][6][1];
			var point,$iter1_iter,xmin,ymin,ymax,$add20,$sub9,$iter1_array,xpts,$iter1_nextval,$sub13,$sub12,$sub11,$sub10,$sub16,$sub15,$sub14,$add14,$add15,$add16,$add17,$add13,ypts,$add18,$add19,$iter1_type,$iter1_idx,xmax;
			surface['beginPath']();
	...
	return $collcomp2;}();
			...
			ymax = $tupleassign2[1];
			if ($p['bool']($p['getattr'](surface, '_display'))) {
				return surface['_display']['_surface_rect']['clip']($m['Rect'](xmin, ymin, $p['__op_add']($add13=$p['__op_sub']($sub9=xmax,$sub10=xmin),$add14=1), $p['__op_add']($add15=$p['__op_sub']($sub11=ymax,$sub12=ymin),$add16=1)));
			}
			else {
				return surface['get_rect']()['clip']($m['Rect'](xmin, ymin, $p['__op_add']($add17=$p['__op_sub']($sub13=xmax,$sub14=xmin),$add18=1), $p['__op_add']($add19=$p['__op_sub']($sub15=ymax,$sub16=ymin),$add20=1)));
			}
			return null;
		}
	...
	return $collcomp4;}();
			...
			ymax = $tupleassign4[1];
			if ($p['bool']($p['getattr'](surface, '_display'))) {
				return surface['_display']['_surface_rect']['clip']($m['Rect'](xmin, ymin, $p['__op_add']($add21=$p['__op_sub']($sub17=xmax,$sub18=xmin),$add22=1), $p['__op_add']($add23=$p['__op_sub']($sub19=ymax,$sub20=ymin),$add24=1)));
			}
			else {
				return surface['get_rect']()['clip']($m['Rect'](xmin, ymin, $p['__op_add']($add25=$p['__op_sub']($sub21=xmax,$sub22=xmin),$add26=1), $p['__op_add']($add27=$p['__op_sub']($sub23=ymax,$sub24=ymin),$add28=1)));
			}
			return null;
		}
	, 1, [null,null,['self'],['surface'],['color'],['point1'],['point2'],['width', 1]]);
		...
		$method = $pyjs__bind_method2('lines', function(surface, color, closed, pointlist, width) {
			...
			if (typeof width == 'undefined') width=arguments['callee']['__args__'][7][1];
			var $sub26,$sub27,point,$sub28,$sub29,$sub32,xmin,$iter6_iter,ymin,$iter6_nextval,$add29,ymax,$sub25,$iter6_type,$sub31,$sub30,xpts,$iter6_idx,$iter6_array,ypts,$add32,$add33,$add30,$add31,$add36,$add34,$add35,xmax;
			surface['beginPath']();
			$pyjs_kwargs_call(surface, 'moveTo', pointlist['__getitem__'](0), null, [{}]);
	...
	return $collcomp6;}();
			...
			ymax = $tupleassign6[1];
			if ($p['bool']($p['getattr'](surface, '_display'))) {
				return surface['_display']['_surface_rect']['clip']($m['Rect'](xmin, ymin, $p['__op_add']($add29=$p['__op_sub']($sub25=xmax,$sub26=xmin),$add30=1), $p['__op_add']($add31=$p['__op_sub']($sub27=ymax,$sub28=ymin),$add32=1)));
			}
			else {
				return surface['get_rect']()['clip']($m['Rect'](xmin, ymin, $p['__op_add']($add33=$p['__op_sub']($sub29=xmax,$sub30=xmin),$add34=1), $p['__op_add']($add35=$p['__op_sub']($sub31=ymax,$sub32=ymin),$add36=1)));
			}
			return null;
		}
