	...
	$m['Color'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			if ($p['bool']($p['op_eq'](ln, 4))) {
				...
				if ($p['bool'](($p['bool']($and1=$p['hasattr'](_color, 'startswith'))?_color['startswith']('#'):$and1))) {
					_color = $p['__op_add']($add1='0x',$add2=$p['__getslice'](_color, 1, null));
				}
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__eq__', function(other) {
			...
			if ($p['bool']($p['hasattr'](other, 'a'))) {
				return ($p['bool']($and3=$p['op_eq']($p['getattr'](self, 'r'), $p['getattr'](other, 'r')))?($p['bool']($and4=$p['op_eq']($p['getattr'](self, 'g'), $p['getattr'](other, 'g')))?($p['bool']($and5=$p['op_eq']($p['getattr'](self, 'b'), $p['getattr'](other, 'b')))?$p['op_eq']($p['getattr'](self, 'a'), $p['getattr'](other, 'a')):$and5):$and4):$and3);
			}
			else {
				if ($p['bool']($p['op_eq']($p['len'](other), 4))) {
					return ($p['bool']($and7=$p['op_eq']($p['getattr'](self, 'a'), other['__getitem__'](3)))?($p['bool']($and8=$p['op_eq']($p['getattr'](self, 'r'), other['__getitem__'](0)))?($p['bool']($and9=$p['op_eq']($p['getattr'](self, 'g'), other['__getitem__'](1)))?$p['op_eq']($p['getattr'](self, 'b'), other['__getitem__'](2)):$and9):$and8):$and7);
				}
				else {
					return ($p['bool']($and11=$p['op_eq']($p['getattr'](self, 'r'), other['__getitem__'](0)))?($p['bool']($and12=$p['op_eq']($p['getattr'](self, 'g'), other['__getitem__'](1)))?$p['op_eq']($p['getattr'](self, 'b'), other['__getitem__'](2)):$and12):$and11);
				}
			}
			return null;
		}
